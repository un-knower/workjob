...
object Kmeans {
    def main(args: Array[String]): Unit = {
        ...
        // 装载数据集
        val data = sc.textFile("D:\\workingspace\\code\\IDEA\\workjob\\src\\main\\resources\\learning\\kmeans_data.txt", 1)
        ...
        result1.saveAsTextFile("src/main/resources/out/result_kmeans1.txt")
        // 交叉评估 2，返回数据集和结果
        val result2 = data.map {
            line =>
                ...
                line + " " + prediction
        }.saveAsTextFile("src/main/resources/out/result_kmeans2.txt")
        sc.stop()
    }
