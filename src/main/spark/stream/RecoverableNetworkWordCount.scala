...
import org.apache.spark.util.{LongAccumulator, IntParam}
...
/**
  ...
  * shows how to use lazily instantiated singleton util for Accumulator and Broadcast so that
  ...
  *
  * `$ ./bin/run-example org.apache.spark.examples.stream.RecoverableNetworkWordCount \
        ...
        if (args.length != 4) {
            ...
            System.err.println(
                """
                  ...
                  |     StreamingOp would connect to receive data. <checkpoint-directory> directory to
