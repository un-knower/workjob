...
object Main extends App {
    ...
    val result1 = Future.sequence(Set(
        ...
        Future {
            getEx(600, new IllegalStateException("1"))
        },
        Future {
            getData(3)
        },
        Future {
            getEx(300, new IllegalStateException("4"))
        }))
    ...
    println("traverse")
    val result2 = Future.traverse(1 to 4)(n => Future {
        getData(n)
    })
    ...
    println("reduceLeft")
    val futures3 = (1 to 4).map(n => Future {
        getData(n)
    })
    ...
    val futures4 = (1 to 4).map(n => Future {
        getData(n)
    })
    ...
    println("find")
    val futures5 = (1 to 4).map(n => Future {
        getData(n)
    })
